...
public interface CollectionService {
     ...
     * @param description 收藏夹描述
     */
    void updateCollectionGroup(Long groupId, String name, String description);
     ...
     * @param groupId 收藏夹ID
     */
    void removeCollectionGroup(Long groupId);
     ...
     * @param nkid 视频投稿ID
     */
    void addCollection(Long groupId, Long nkid);
     ...
     * @param nkid 视频投稿ID
     */
    void removeCollection(Long groupId, Long nkid);
     ...
     * @return 稿件ID列表
     */
    List<Collection> getCollections(Long groupId);
}
